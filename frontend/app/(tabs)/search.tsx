    ...
    >
      ...
      <View style={styles.venueInfo}>
        ...
        <View style={styles.bottomRow}>
          <Text style={styles.capacityText}>{item.capacity_min}-{item.capacity_max}</Text>
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          ...
          >
            <Text style={[styles.chipText, eventType === item.id && styles.chipTextActive]}>{item.label}</Text>
          </TouchableOpacity>
        )}
      />
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptySubtext}>Proprietarii nu au publicat încă locații{eventType ? ' pentru acest tip de eveniment' : ''}.</Text>
            </View>
          }
        />
      )}
...
const styles = StyleSheet.create({
  ...
  filterBtn: {
    width: 48, height: 48, borderRadius: radius.lg, backgroundColor: colors.surfaceHighlight,
  ...
  tagsOverlay: { position: 'absolute', top: spacing.sm, left: spacing.sm, flexDirection: 'row', gap: 4 },
  tagBadge: { backgroundColor: 'rgba(0,0,0,0.7)', paddingHorizontal: 8, paddingVertical: 3, borderRadius: radius.full },
  ...
  sortOption: {
    ...
    paddingVertical: 14, paddingHorizontal: spacing.md, borderRadius: radius.md, marginBottom: spacing.xs,
  },
