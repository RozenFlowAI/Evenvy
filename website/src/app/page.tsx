...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      {/* CTA Section - Pentru proprietari (vizibil doar dacă NU ești proprietar logat) */}
      {!isOwner && (
        <section
          style={{
      ...
      {/* CTA Section - Pentru proprietari logați (alternativa utilă) */}
      {isOwner && (
        <section
          style={{
            background: `linear-gradient(135deg, ${c.primary}20 0%, ${c.surface} 100%)`,
        ...
        >
          ...
          <p style={{ fontSize: 18, color: c.textSecondary, marginBottom: 32 }}>
            Gestionează-ți locațiile și vezi cererile primite în Dashboard.
          </p>
          <Link
            href="/dashboard"
            style={{
